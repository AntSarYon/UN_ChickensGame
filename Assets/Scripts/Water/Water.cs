...
{
    public Slider mWaterLevelSlider;
    ...
    [Range(1, 5)][SerializeField] private float waterDecreaseSpeed;
    ...
    void Update()
    {
        ...
        if (chickensList.Count > 0)
        {
            ...
            mWaterLevelSlider.value -= chickensList.Count * Time.deltaTime * waterDecreaseSpeed;
        }
    }
